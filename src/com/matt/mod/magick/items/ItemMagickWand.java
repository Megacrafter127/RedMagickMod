	            ...
	            public void addInformation(ItemStack itemStack, EntityPlayer player,
	            	...
	            	if(Keyboard.isKeyDown(Keyboard.KEY_LSHIFT)) {
	            	   if (itemStack.stackTagCompound != null) { 
	            		   ...
	            		   list.add(EnumChatFormatting.BLUE + "Current Skot�di level :  " +itemStack.stackTagCompound.getInteger("dark"));
	            		   list.add(EnumChatFormatting.BLUE + "Current Mag�ia level:  " +itemStack.stackTagCompound.getInteger("magic"));
	            		   ...
	            		   list.add(EnumChatFormatting.BLUE + "Current Ner� power :  " +itemStack.stackTagCompound.getInteger("water"));
	            		   list.add(EnumChatFormatting.BLUE + "Current A�ras power :  " +itemStack.stackTagCompound.getInteger("air"));
	            		   ...
	            		   list.add(EnumChatFormatting.BLUE + "Current Deisidaimon�a power :  " +itemStack.stackTagCompound.getInteger("death"));
